    ...
    try {
      ...
      const { data: insertedPhoto, error: insertError } = await supabase
        ...
        .insert({
          ...
          watermark_asset: uploadWatermarkAsset,
          watermark_position: uploadWatermarkPosition,
          watermark_scale_percent: uploadWatermarkScale,
          width,
          height,
        })
        .select("*")
    ...
    try {
      ...
      const { data: updatedPhoto, error: updateError } = await supabase
        ...
        .update({
          ...
          thumbnail_path: thumbPath,
          thumbnail_size_bytes: thumbBlob.size,
          watermark_asset: editWatermarkAsset,
          watermark_position: editWatermarkPosition,
          watermark_scale_percent: editWatermarkScale,
          width,
          height,
          updated_by: currentUserId,
        })
